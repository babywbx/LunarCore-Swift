...
| 来源 | 地位 | 用途 |
|------|------|------|
| **中国科学院紫金山天文台** | 中国农历唯一官方编算机构。现行农历（紫金历）由该台计算，属于《中国天文年历》的组成部分。 | **最终校验标准**——我们的精度目标就是与紫金山天文台的结果零偏差 |
| **GB/T 33661-2017《农历的编算和颁行》** | 2017年发布的中国国家标准，由紫金山天文台起草 | 定义农历编排规则：朔日定义、节气定义、闰月规则、时间标准 |

### 2.2 算法理论来源（全部是公开发表的科学文献）
